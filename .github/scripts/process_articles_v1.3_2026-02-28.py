...
# ─── VERSION HEADER ────────────────────────────────────────────────────────────
# v1.3 — 2026-02-28 — injected CSS overrides article background to navy to match main site
...
body { padding-top: 88px !important; background: #0f1f38 !important; color: rgba(255,255,255,0.82) !important; }
/* Override article inline styles for navy background */
body > div { background: #0f1f38 !important; }
body > div > div:last-child { background: #0f1f38 !important; }
</style>"""
