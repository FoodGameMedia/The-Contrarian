...
# ─── VERSION HEADER ────────────────────────────────────────────────────────────
# v1.6 — 2026-02-28-1810 — exact fonts link and border colour from main site source
...
.fgm-nav.hidden { transform: translateY(-100%); }
.fgm-nav-inner {
...
<script>
(function(){
  var nav=document.getElementById('fgmNav'), last=0;
  window.addEventListener('scroll',function(){
    var y=window.scrollY;
    nav.classList.toggle('hidden', y>last && y>72);
    last=y;
  }, {passive:true});
})();
</script>"""
